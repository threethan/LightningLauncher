...
//        setChangeDuration(175);
    ...
    public void runPendingAnimations() {
        ...
        if (additionsPending) {
            ...
            if (removalsPending || movesPending || changesPending) {
                ...
                // Edit: Don't fully wait on moves
                ViewCompat.postOnAnimationDelayed(view, adder, totalDelay/4);
            } else {
                adder.run();
            }
        }
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0)
                .scaleX(0.5f).scaleY(0.5f).setListener(
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        if (deltaX != 0) {
            view.animate().translationX(0).setInterpolator(new DecelerateInterpolator());
        }
        if (deltaY != 0) {
            view.animate().translationY(0).setInterpolator(new DecelerateInterpolator());
        }
        final ViewPropertyAnimator animation = view.animate();
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0f).setListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationStart(Animator animator) {
